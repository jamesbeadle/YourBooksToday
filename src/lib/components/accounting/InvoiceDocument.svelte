...
<article
	class="flex flex-col gap-10 rounded-2xl bg-paper p-12 text-ink shadow-2xl
...
>
	...
	<section class="grid gap-8 sm:grid-cols-2">
		<div class="whitespace-pre-line">
			<p class="font-mono text-xs tracking-widest uppercase opacity-60">Billed to</p>
	...
	<footer class="flex flex-col gap-4 border-t border-rule pt-6 text-sm">
