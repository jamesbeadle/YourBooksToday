<div class="flex flex-col gap-4">
	<p class="font-mono text-sm tracking-widest text-go uppercase">Message received</p>
	<h2 class="font-display text-2xl font-medium">Thank you — we will be in touch.</h2>
