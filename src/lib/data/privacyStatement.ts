...
export const privacyStatement: LegalDocument = {
	...
	metaDescription:
		'How Your Books Today collects, uses, protects, and deletes your information — across the consultancy, knowledge bases, chatbots and the client portal — and the promise we make about your knowledge.',
