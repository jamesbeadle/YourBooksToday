...
export const termsOfService: LegalDocument = {
	...
	metaDescription:
		'The terms that govern your use of Your Books Today — the consultancy, accounts and credits, knowledge bases, chatbots, the client portal, and the API and MCP server.',
